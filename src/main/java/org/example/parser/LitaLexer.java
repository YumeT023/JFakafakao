...
public class LitaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "NOMERIKA", "ISA", "TEBOKA", "NL", "ADD", "SUB", "MULT", "DIV", 
			"GT", "GTE", "LT", "LTE", "EQ", "NA", "SY", "VOAMBOLANA", "WS"
		};
	}
	...
	public LitaLexer(CharStream input) {
		super(input);
